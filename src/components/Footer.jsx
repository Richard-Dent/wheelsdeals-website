      ...
      <div className='flex flex-col md:flex-row justify-between p-8 lg:px-28 md:px-16 px-5'>
        <div className='w-full md:w-1/4'>
          ...
          <p className='mb-2 text-sm'>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempore ducimus sed, modi, corporis repellendus quos consectetur itaque recusandae id voluptas dolores, assumenda harum. Ipsa, voluptas?
          </p>
        </div>
        <div>
